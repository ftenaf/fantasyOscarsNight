...
export enum NomineesEnum{
  bestpicture = "bestpicture",
  actorinaleadingrole = "actorinaleadingrole",
  actressinaleadingrole = "actressinaleadingrole",
  actorinasupportingrole = "actorinasupportingrole",
  actressinasupportingrole = "actressinasupportingrole",
  animatedfeaturefilm = "animatedfeaturefilm",
  cinematography = "cinematography",
  costumedesign = "costumedesign",
  directing = "directing",
  documentaryfeature = "documentaryfeature",
  documentaryshort = "documentaryshort",
  filmediting = "filmediting",
  internationalfeaturefilm = "internationalfeaturefilm",
  makeupandhairstyling = "makeupandhairstyling",
  musicoriginalscore = "musicoriginalscore",
  musicoriginalsong = "musicoriginalsong",
  productiondesign = "productiondesign",
  shortfilmanimated = "shortfilmanimated",
  shortfilmliveaction = "shortfilmliveaction",
  soundediting = "soundediting",
  soundmixing = "soundmixing",
  visualeffects = "visualeffects",
  writingadaptedscreenplay = "writingadaptedscreenplay",
  writingoriginalscreenplay = "writingoriginalscreenplay",
}
